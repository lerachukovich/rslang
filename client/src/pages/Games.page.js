...
const GamesPage = () => {
    const games = [
        ...
        {
            name: 'Своя игра',
            text: 'Своя игра - игра, в которой вам нужно будет вставить в пропущенное в предложении место нужное слово – причем варианты могут быть созвучны и похожи. Это позволит вам осваивать новую лексику и не путаться в похожих фразах, если они встречаются в языке.',
            img_source: img4,
            url: '/games/owngame'
        },
    ]
