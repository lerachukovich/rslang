...
const OwnGamePromo = () => {
    ...
    return (
        <div>
            ...
            <h1 className={'savanna-promo__title own-title'}>Расставь слова</h1>
            <p className={"savanna-promo__depict own-depict"}>Расставь слова - игра, в которой вам нужно будет вставить в пропущенное в предложении место нужное слово – причем варианты могут быть созвучны и похожи. Это позволит вам осваивать новую лексику и не путаться в похожих фразах, если они встречаются в языке.</p>
            <p className={"savanna-promo__tutorial own-tutorial"}>После запуска игры вы увидите предложение с пропущенным словом на английском языке, а также 4 варианта ответа. Ваша задача - внимательно прочитать предложение и из предложенных вариантов слов выбрать наиболеее подходящее по смыслу для того, чтобы завершить предложение. </p>
