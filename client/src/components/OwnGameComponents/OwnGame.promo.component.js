...
const OwnGamePromo = () => {
    ...
    return (
        <div>
            ...
            <h1 className={'savanna-promo__title'}>Своя игра</h1>
            <p className={"savanna-promo__depict"}>Своя игра - игра, в которой вам нужно будет вставить в пропущенное в предложении место нужное слово – причем варианты могут быть созвучны и похожи. Это позволит вам осваивать новую лексику и не путаться в похожих фразах, если они встречаются в языке.</p>
